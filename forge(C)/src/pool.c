...
// slots need to be at least pointer-sized so we can embed the free-list link
...
void* forge_pool_alloc(forge_pool_t* pool) {
    ...
    // poison with 0xAB so use-before-init shows up immediately in a debugger
