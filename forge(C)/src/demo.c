...
static void bench_arena(void) {
    ...
    printf("Arena  — %d allocs+resets in %.2f ms  |  "
           "capacity=%zu overflow=%zu\n",
...
static void bench_pool(void) {
    ...
    printf("Pool   — %ld rounds x %zu in %.2f ms  |  "
           "peak=%zu total_allocs=%zu\n",
...
static void bench_slab(void) {
    ...
    printf("Slab   — %d alloc/free pairs in %.2f ms  |  "
           "classes=%d total_in_use=%zu\n",
